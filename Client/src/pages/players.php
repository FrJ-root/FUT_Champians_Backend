    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr class='hover:bg-gray-100'>
            ...
            <td class='border px-4 py-2 flex justify-center items-center space-x-4'>
                <a href='edit_player.php?id={$row['id']}' class='text-blue-500 hover:text-blue-700 transition-transform duration-200 transform hover:scale-125 mt-4 mb-5'>
                    <i class='fas fa-edit text-lg shadow hover:shadow-lg'></i>
                </a>
                <a href='delete_player.php?id={$row['id']}' class='text-red-500 hover:text-red-700 transition-transform duration-200 transform hover:scale-125 mt-4 mb-5''>
